/*
    GamePieces class is the child class of the Player class.
    It is the parent class of the Bishop, King, Knight, Pawn, Queen, Rook classes.
*/
...
public:
    ...
    // checks if the move is in the board then returns the values to isMoveLegalForPiece to check if the piece can legally complete that move
